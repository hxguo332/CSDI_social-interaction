...
#SBATCH -t 24:00:00
#SBATCH --array=0-1
#SBATCH -o ./srun_logs/reordered_randomtarget_knowfirst_%A_%a.out
#SBATCH -e ./srun_logs/reordered_randomtarget_knowfirst_%A_%a.err
...
SCENARIOS=("3-1" "4-1")
VARIANTS=("obs_loss" "social_loss" "goal_full")
...
echo "============================================================"
echo "Reordered ablation: know-first target + know-first missing"
...
for VARIANT in "${VARIANTS[@]}"; do
    CFG_NAME="generated_ablation/reordered_randomtarget_knowfirst_${SCENARIO}_${VARIANT}_e${EPOCHS}_len${DATA_LENGTH}_n${NSAMPLE}.yaml"
...
PY
    ...
    echo "Running reordered know-first ${VARIANT} on scenario ${SCENARIO}"
...
echo "============================================================"
echo "All reordered know-first variants finished for scenario ${SCENARIO}"
echo "Finished: $(date)"
echo "============================================================"