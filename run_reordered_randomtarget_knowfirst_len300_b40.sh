...
for VARIANT in "${VARIANTS[@]}"; do
    CFG_NAME="generated_ablation/reordered_randomtarget_knowfirst_len300_b40_${SCENARIO}_${VARIANT}_e${EPOCHS}_len${DATA_LENGTH}_n${NSAMPLE}.yaml"
...
PY
    ...
    echo "Running reordered random-target know-first ${VARIANT} on ${SCENARIO}"
    ...
    echo "Finished reordered random-target know-first ${VARIANT} on ${SCENARIO}: $(date)"
done
