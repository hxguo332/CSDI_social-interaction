...
#SBATCH -o ./srun_logs/resume_%A_%a.out

#SBATCH -e ./srun_logs/resume_%A_%a.err
...
read SCENARIO VARIANT <<< "${CASES[$SLURM_ARRAY_TASK_ID]}"
...
CFG_NAME="generated_ablation/resume_${SCENARIO}_${VARIANT}_e${EPOCHS}_len${DATA_LENGTH}_n${NSAMPLE}.yaml"
