...
#SBATCH -t 48:00:00
#SBATCH --array=0-3
#SBATCH -o ./srun_logs/legacy_knowfirst_len300_b40_%A_%a.out
#SBATCH -e ./srun_logs/legacy_knowfirst_len300_b40_%A_%a.err
...
VARIANTS=("task" "goal" "social" "fusion" "obs_loss" "full")
...
echo "============================================================"
echo "Legacy ablation: know-first target + know-first missing | len300 b40"
...
for VARIANT in "${VARIANTS[@]}"; do
    CFG_NAME="generated_ablation/legacy_knowfirst_len300_b40_${SCENARIO}_${VARIANT}_e${EPOCHS}_len${DATA_LENGTH}_n${NSAMPLE}.yaml"
...
PY
    ...
    echo "Running legacy know-first ${VARIANT} on ${SCENARIO}"
    ...
    echo "Finished legacy know-first ${VARIANT} on ${SCENARIO}: $(date)"
done
